...
function find() {
  return db('users as ur')
    .join('roles as rl', 'ur.role_id', 'rl.role_id')
    .select('ur.user_id', 'ur.username', 'rl.role_name')
  /**
...
function findBy(filter) {
  return db('users as ur')
    .join('roles as rl', 'ur.role_id', 'rl.role_id')
    .select('ur.user_id', 'ur.username', 'ur.password', 'rl.role_name')
    .where(filter)
  /**
    You will need to join two tables.
